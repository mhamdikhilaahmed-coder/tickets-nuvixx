...
async def health_handler(request):
    ...
    return web.Response(text=f"Nuvix Sanctions connected | alive {alive}s")
...
async def main():
    if not TOKEN:
        raise RuntimeError(f"Missing token env: NUVIX_SANCTIONS_TOKEN")
